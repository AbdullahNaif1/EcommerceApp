    ...
    stages {
        ...
        stage('Build Docker Image') {
            steps {
                ...
                sh 'docker build -t abdullah919191/EcommerceApp .'
            }
        }
        stage('Push to Docker Hub') {
            steps {
                ...
                sh 'docker push abdullah919191/EcommerceApp'
            }
        }
        stage('Deploy Docker Container') {
            steps {
                ...
                script {
                    try {
                        sh 'docker stop pEcommerceApp'
                        sh 'docker rm pEcommerceApp'
                    } catch (Exception e) {
                ...
                sh 'docker run -d --name pEcommerceApp -p 9805:9805 abdullah919191/EcommerceApp:latest'
            }
        }
    }
}
